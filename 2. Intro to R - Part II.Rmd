...
The *sapply()* function accepts a vector or a list as the first argument. The 2nd argument is a function to be applied to each element of the vector / list given as the 1st argument. The result is a vector of the computed values.
